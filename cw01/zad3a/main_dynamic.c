...
{
    dll = dlopen("./library.so", RTLD_LAZY);
    typedef struct BlockArray BlockArray;
    typedef struct BlockArrayStatic BlockArrayStatic;
    BlockArray *(*createArray)(int, int) = dlsym(dll, "createArray");
    BlockArrayStatic *(*createArrayStatic)() = dlsym(dll, "createArrayStatic");
    char *(*getBlockWithClosestAsciiValue)(BlockArray*, int) = dlsym(dll, "getBlockWithClosestAsciiValue");
    char *(*getBlockWithClosestAsciiValueStatic)(BlockArrayStatic*, int) = dlsym(dll, "getBlockWithClosestAsciiValueStatic");
    void (*deleteBlocks)(BlockArray*, int, int) = dlsym(dll, "deleteBlocks");
    char *(*createBlockWithValue)(BlockArray*, int, char*) = dlsym(dll, "createBlockWithValue");
    void (*eraseBlocksStatic)(BlockArrayStatic*, int, int) = dlsym(dll, "eraseBlocksStatic");
    void (*setBlockValueStatic)(BlockArrayStatic*, int, char*) = dlsym(dll, "setBlockValueStatic");
    void (*deleteThenCreateBlocks)(BlockArray*, int, int, int) = dlsym(dll, "deleteThenCreateBlocks");
    void (*setBlockValue)(BlockArray*, int, char*) = dlsym(dll, "setBlockValue");
    void (*deleteArray)(BlockArray*) = dlsym(dll, "deleteArray");
    void (*deleteArrayStatic)(BlockArrayStatic*) = dlsym(dll, "deleteArrayStatic");
